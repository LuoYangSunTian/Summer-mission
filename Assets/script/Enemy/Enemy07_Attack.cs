...
public class Enemy07_Attack : MonoBehaviour, Recycleable
{

    public Vector2 rec;
    public Vector3 targetPos;
    public static string prefabWays = "Prefabs/Enemy/Enemy07_Attack";
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            PoolManager.Recycle<Enemy07_Attack>(this, prefabWays);
        }
    }
